        ...
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 space-y-8">
            ...
            <p className="text-emerald-700 text-lg leading-relaxed">
              Experience how VrikshVed leverages cutting-edge computer vision to analyze plant health in real-time.
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        {/* <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-12"> */}
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-xl font-semibold">VrikshVed</span>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm">
              <p className="text-slate-300">contact@vrikshved.com</p>
        ...
        <div className="border-t border-slate-800 pt-8 text-center">
          <p className="text-slate-400 text-sm">
            © {new Date().getFullYear()} VrikshVed. All rights reserved.
          </p>
        </div>
      </div>
      </footer>
