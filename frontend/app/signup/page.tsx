...
//                 className="w-full pl-10 pr-4 py-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-black"
//                 required
//               />
//             </div>
//           </div>
...
//                 className=  " text-black w-full pl-10 pr-4 py-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
//                 required
//               />
//             </div>
//           </div>
